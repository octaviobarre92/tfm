...
export const ListStudents = ({ getStudents, updateStudent, dataStudents, isFetching }) => {
    ...
    return (
        <>
            ...
            {item && <ModalStudents item={item} setItem={setItem} updateStudent={updateStudent} showModal={showModal} setShowModal={setShowModal} />}
        </>
    )
}
